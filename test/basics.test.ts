...
describe("Basic Types", () => {
	...
	describe("Object Parsing", () => {
		...
		it("should parse multiple objects with text between", () => {
			const input =
				'prefix {"key": "value1"} some random text {"key": "value2"} suffix';
			const expected = { key: "value1" };
      ...
      `.trim();
			...
			const expected = [
				...
				},
				{
					...
					English: "Arcadia is a vast land, with monsters and dangers!",
					Portuguese:
						"Arcadia é uma terra vasta, repleta de monstros e perigos!",
				},
				{
					id: "CH1_03",
					English:
  ...
  "headings": [
    {
      ...
      `.trim();
       ...
       return 'Large Green Area' in property['amenities'] or 'Garden' in property['amenities']`,
						description:
							"Properties that offer a serene living experience amidst the bustling city life.",
					},
				],
			};
